document.addEventListener("DOMContentLoaded", () => {
  ...
  // 假设 map 和 BMapGL 是在其他地方定义的全局变量
  // 确保在使用它们之前已经正确初始化
  if (typeof map === "undefined") {
    console.warn("map is not defined. Ensure the Baidu Maps API is loaded.")
  }

  if (typeof BMapGL === "undefined") {
    console.warn("BMapGL is not defined. Ensure the Baidu Maps GL API is loaded.")
  }
})
